...
<body>
  ...
  <div class="navi">
    ...
    <div class="menu">
      <ul>
        <a href="./Landing page for expense tracker/remind.html"><button>
            <li>HOME</li>
          </button></a>
        <a href="./dash.php"><button>
            <li>ADMIN</li>
          </button></a>
        <a href="./currency.php"><button>
            <li>CURRENCY CONVERTER</li>
          </button></a>
        <a href="./calculator.html"><button>
            <li>CALCULATOR</li>
          </button></a>
  ...
  <span class="time" style="color: rgb(4, 76, 185); margin-top:20px; font-size:20px;">00:00:00</span>
  <h2 class="greeting" style="color: rgb(4, 76, 185);">GOOD MORNING</h2>

  <div class="container">

    <div class="b">
      <h4 style="color: rgb(4, 76, 185); font-weight:bolder;">Available Balance:</h4>
    ...
    <div class="incom">
      <form action="expense.php" method="POST" enctype="multipart/form-data">
        ...
        <div class="form-control">
          <label for="text">
            <h5 class="message">Payer's Name</h5>
          </label>
          <input type="text" id="tit" name="name" placeholder="Enter name..." required />
        </div>
        <div class="form-control">
          <label for="amount">
            <h5 class="message">Amount Being Paid</h5> <br />
        ...
        <input style=" background:rgb(4, 76, 185); color: white; border:2px solid rgb(4, 76, 185); margin-left:50px; margin-bottom:20px; margin-top:20px;" type="file" id="submit" name="img" accept="image/*" required>
